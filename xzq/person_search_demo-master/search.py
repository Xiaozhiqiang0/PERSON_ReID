    ...
    for i, (path, img, im0, vid_cap) in enumerate(dataloader):
        ...
        if det is not None and len(det) > 0:
            ...
            if gallery_img:
                ...
                # 查询特征张量求平方，加和，在扩展到（m,n),gallery的特征张量平方加和后扩展到(n,m)在转置，和上一个张量相加
                ...
                if distmat[index] < dist_thres:
                    ...
                    # cv2.waitKey()
        num_allqueryperson.append(num_queryperson)
        ...
        print("第{}人出现{}次".format(num_allqueryperson[i], i + 1))
    print("待查询目录中共有{}人".format(int(len(num_allqueryperson))))
    # for num in len(num_allqueryperson):
    #     print("第{}人出现{}次".format(num + 1, num_allqueryperson[num]))
